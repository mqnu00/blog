...
discussion:
  id: D_kwDOQdT3Qc4Alc3o
  number: 56
  title: 最近开发时遇到的问题(var和async)
  url: 'https://github.com/mqnu00/blog/discussions/56'
  createdAt: '2026-04-03T05:22:45Z'
---
...
问题在于希望一个请求的结果，解析处理后作为另一个请求的参数，就有先后顺序，导致出现了复杂的嵌套，即回调地狱。
还是有点头疼的。
