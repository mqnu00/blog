import{_ as a,c as i,o as n,ag as t}from"./chunks/framework.BOtHsOn_.js";const E=JSON.parse('{"title":"VitePress中的Markdown扩展功能","description":"","frontmatter":{"title":"VitePress中的Markdown扩展功能","date":"2025-01-17T00:00:00.000Z","author":"广习习","tags":["技术分享","Markdown","VitePress"]},"headers":[],"relativePath":"posts/markdown-extensions.md","filePath":"posts/markdown-extensions.md"}'),e={name:"posts/markdown-extensions.md"};function l(p,s,h,r,k,o){return n(),i("div",null,[...s[0]||(s[0]=[t(`<h1 id="vitepress中的markdown扩展功能" tabindex="-1">VitePress中的Markdown扩展功能 <a class="header-anchor" href="#vitepress中的markdown扩展功能" aria-label="Permalink to &quot;VitePress中的Markdown扩展功能&quot;">​</a></h1><p>在使用VitePress搭建博客时，了解其内置的Markdown扩展功能是非常有帮助的。本文将详细介绍一些常用的扩展功能。</p><h2 id="语法高亮" tabindex="-1">语法高亮 <a class="header-anchor" href="#语法高亮" aria-label="Permalink to &quot;语法高亮&quot;">​</a></h2><p>VitePress提供由 <a href="https://github.com/shikijs/shiki" target="_blank" rel="noreferrer">Shiki</a> 驱动的语法高亮，还具有行高亮等附加功能：</p><p><strong>示例代码</strong></p><div class="language-md vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">\`\`\`js{4}</span></span>
